...
def welcome():
    ...
    textarea.insert(END,f"\n-------------------------------------------------------------------------------------------")
    textarea.insert(END,"\nMineral Name\t\tMineral Quantity\t\tPrice per gram")
    textarea.insert(END,f"\n-------------------------------------------------------------------------------------------\n")
    textarea.configure(font='arial 11')



title=Label(root,pady=2,text="Recycling Software",bd=12,bg=bg_color,fg='white',font=('times new roman', 25 ,'bold'),relief=GROOVE,justify=CENTER)
title.pack(fill=X)

#Product Frames
F1=LabelFrame(root,bd=10,relief=GROOVE,font=('times new romon',15,'bold'),fg='gold',bg=bg_color)
F1.place(x=0,y=80,relwidth=1)

cname_lbl=Label(F1,text='Product Name',font=('times new romon',18,'bold'),bg=bg_color,fg='white').grid(row=0,column=0,padx=20,pady=5)
cname_txt=Entry(F1,width=15,textvariable=c_name,font='arial 15 bold',relief=SUNKEN,bd=7).grid(row=0,column=1,padx=10,pady=5)

cphone_lbl=Label(F1,text='Customer Name ',font=('times new romon',18,'bold'),bg=bg_color,fg='white').grid(row=0,column=2,padx=20,pady=5)
...
itm= Label(F2, text='Mineral Name', font=('times new romon',18, 'bold'), bg=bg_color, fg='lightgreen').grid(
...
rate= Label(F2, text='Mineral Rate per gram', font=('times new romon',18, 'bold'), bg=bg_color, fg='lightgreen').grid(
...
n= Label(F2, text='Mineral Quantity (in gram)', font=('times new romon',18, 'bold'), bg=bg_color, fg='lightgreen').grid(
